$( document ).ready(function(){
    ...
    $('.product__gallery-sticky').removeAttr('style');
...

    {
        ...
        if (searchBox.length) {
            ...
            let searchBoxOffsetLeft;

            if (searchBoxOffset.left) {
                searchBoxOffsetLeft = searchBoxOffset.left;
            }
