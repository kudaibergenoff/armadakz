...
@section('title','ARMADA - изменить(создать) тариф' )
        ...
        <div class="d-flex">
            ...
            <div class="vendor__content flex-grow-1 vendor__content--products">
                ...
                <div class="shops orders vendor__shops pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    ...
                    <form action="@isset($data){{ route('admin.tarifs.update',$data->id) }}@else{{ route('admin.tarifs.store') }}@endisset" class="change-shop pb-4 border-bottom was-validated" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 col-lg mb-3">
                                @include('layouts.forms.input',['name'=>'placement_price','label'=>'Цена','placeholder'=>'Цена','length'=>15,'required'=>true])
                            </div>
                            <div class="col-4 col-lg mb-3">
                                @include('layouts.forms.input',['name'=>'limit_store_products','type'=>'number','label'=>'Количество продуктов','placeholder'=>'введите данные','length'=>15,'required'=>true])
                            </div>
                        </div>
