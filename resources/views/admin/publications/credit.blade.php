...
@section('title','ARMADA - Добавить/редактировать новость' )
        ...
        <div class="d-flex">
            ...
            <div class="vendor__content flex-grow-1 vendor__content--products">
                ...
                <div class="shops orders vendor__shops pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    ...
                    <form action="@isset($data){{ route('admin.publications.update',$data->id) }}@else{{ route('seller.news.store') }}@endisset" class="change-shop pb-4 border-bottom was-validated" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-3 mb-3 imgUp">
                                @include('admin.publications._uploadImage')
                            </div>
...
{{--                                    </div>--}}
                                    ...
                                    <div class="col-6 col-lg-3">
                                        <label class="mdb-main-label">Тит публикации</label>
