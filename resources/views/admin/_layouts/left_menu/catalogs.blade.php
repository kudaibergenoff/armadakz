<a href="#" class="vendor-menu__row vendor-menu__row--has-children">
    ...
    <span class="vendor-menu__row-title">Каталог</span>
    ...
    <div class="vendor-menu__dropdown">
        @include('admin._layouts.left_menu._catalogs')
        @include('admin._layouts.left_menu._subcatalogs')
        @include('admin._layouts.left_menu._items')
    </div>
</a>
