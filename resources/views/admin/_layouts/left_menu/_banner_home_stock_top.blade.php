<a href="{{ route('admin.banners.index') }}" class="vendor-menu__row @if(Route::is('*.index.*')) vendor-menu__row--active @endif">
    ...
    <span class="vendor-menu__row-title">Главная страница - Акционный баннер (верхний)</span>
</a>
