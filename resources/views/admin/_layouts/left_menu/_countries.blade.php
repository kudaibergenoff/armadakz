<a href="{{ route('admin.countries.index') }}" class="vendor-menu__row @if(Route::is('*.countries.*')) vendor-menu__row--active @endif">
    ...
    <span class="vendor-menu__row-title">Страны</span>
</a>
