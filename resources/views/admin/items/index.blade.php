                ...
                <div class="products orders vendor__products pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    <div class="orders__header justify-content-between">
                        <div class="d-flex align-content-center flex-wrap">
                            <h2 class="page-title orders__title mr-4 mb-2">Разделы</h2>
                            <div>
                                <button class="button btn-sm btn-success products__add mr-2 mb-2">
                                    <a href="{{ route('admin.items.create') }}">Добавить</a>
                                </button>
...
{{--                                <button class="button btn-sm btn-light products__filter mr-2 mb-2">Фильтр</button>--}}
                        ...
                        <span class="orders__count">
                            Найдено <b>{{ $items->count() }}</b>
                            @if((isset($_GET['catalog_id']) and is_numeric($_GET['catalog_id'])) or (isset($_GET['subcatalog_id']) and is_numeric($_GET['subcatalog_id'])))
                                по фильтру<br>
                                <a href="{{ route('admin.items.index') }}" class="text-danger font-weight-bold">
                                    <i class="far fa-times-circle"></i> сбросить фильтр
                                </a>
                            @endif
                        </span>
                    </div>
                        ...
                        <table id="dt-multi-checkbox" class="table table-striped" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Slug</th>
                                    <th>
                                        <span class="text-primary mr-1"><i class="fas fa-filter"></i></span>
                                        Подкаталог
                                    </th>
                                    <th>
                                        <span class="text-primary mr-1"><i class="fas fa-filter"></i></span>
                                    ...
                                    <th>Статус</th>
{{--                                    <th>--}}
{{--                                        <span class="text-primary mr-1"><i class="far fa-share-square"></i></span>--}}
{{--                                        К-во элементов--}}
{{--                                    </th>--}}
                                    <th>Дата</th>
                            ...
                            <tbody>
                                @each('admin.items._table_items',$items,'item')
                            </tbody>
                        </table>
                    </div>
                </div>
