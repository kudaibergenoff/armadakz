        ...
        <div class="d-flex">
            ...
            <div class="vendor__content flex-grow-1 vendor__content--products">
                ...
                <div class="orders vendor__shops pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    ...
                    <form action="@isset($user){{ route('admin.sellers.update',$user->id) }}@else{{ route('admin.sellers.store') }}@endisset" class="pb-4 border-bottom" method="POST" enctype="multipart/form-data">
                            ...
                            @foreach($stores as $store)
                                <div class="col-12 col-lg-6 mb-3">
                                    <a href="{{ route('shop',$store->slug) }}" target="_blank">
                                        <span class="text-primary mr-3"><i class="far fa-share-square"></i></span> {{ $store->title }}
                                    </a>
                                </div>
                                <div class="col-12 col-lg-6 mb-3">
                                    <a href="{{ route('admin.stores.edit',$store->id) }}" target="_blank">
                                        <span class="text-primary mr-3"><i class="far fa-edit"></i></span> /{{ $store->slug }}
                                    </a>
                                </div>
                            @endforeach
                        @else
