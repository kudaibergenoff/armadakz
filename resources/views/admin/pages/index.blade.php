...
@section('title','ARMADA - Статические страницы' )
                ...
                <div class="products orders vendor__products pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    <div class="orders__header justify-content-between">
                        <div class="d-flex align-content-center flex-wrap">
                            <h2 class="page-title orders__title mr-4 mb-2">Статические страницы</h2>
{{--                            <div>--}}
{{--                                <a href="{{ route('admin.stores.create') }}" class="button btn-sm btn-success products__add mr-2 mb-2">Добавить</a>--}}
...
{{--                        <span class="orders__count">Найдено <b>{{ $stores->count() }}</b></span><!--  по фильтру -->--}}
                    </div>
...
{{--                                <th>Банеры</th>--}}
                            ...
                            <tbody>
                                @each('admin.pages._table_pages',$pages,'page')
                            </tbody>
                            <tfoot>
                            <tr>
                                <th>Slug</th>
