<div class="images-wrap">
    @if(isset($data) and $data->$name != null)
        @isset($label)
            <label class="text-center font-weight-semibold">{{ $label }}</label>
        @endisset
        <div class="image-upload-wrap">
            <div class="image-upload">
                <div class="image-upload__preview" data-default-image="{{ asset('/img/noimg.jpg') }}" style="background-image: url({{ "/storage/".$data->$name ?? asset('/img/noimg.jpg') }})"></div>
