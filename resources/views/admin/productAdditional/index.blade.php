...
{{--                    </form>--}}
                    ...
                    <div class="orders__header justify-content-between">
                        <div class="d-flex align-content-center flex-wrap">
                            <h2 class="page-title orders__title mr-4 mb-2">Сопутствующие товары для {{ $product->title }}</h2>
                            <div>
                                <button class="button btn-sm btn-success products__add mr-2 mb-2">
                                    <a href="{{ route('admin.additional.create',['product'=>$product->id]) }}">Добавить</a>
                                </button>
...
{{--                                @endif--}}
                        ...
                        <span class="orders__count">Найдено <b>{{ $additionals->count() }}</b>@if(isset($_GET) and count($_GET) > 0) по фильтру @endif</span>
                    </div>
                    ...
                    <div class="table-responsive products-table vendor__products-table">
                        <table id="dt-multi-checkbox" class="table table-striped" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @each('admin.productAdditional._table_additionals',$additionals,'additional')
                            </tbody>
                            <tfoot>
                                <tr>
                                    <th></th>
