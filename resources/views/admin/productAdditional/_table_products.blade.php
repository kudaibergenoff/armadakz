<tr>
    ...
    <td>
        <a href="{{ route('admin.product-additional.index') }}">{{ $product->additional->count() }}</a>
    </td>
...
{{--        <div class="products__status products__status--active">Активный</div>--}}
    ...
    <td class="text-center">
        <button class="products-table__edit" data-toggle="modal" data-target="#quick-edit" data-item-id="{{ $product->id }}">
            <input type="hidden" name="edit-action" value="{{ route('admin.products.edit',$product->id) }}">
            <input type="hidden" name="edit-link" value="{{ route('admin.products.update',$product->id) }}">
