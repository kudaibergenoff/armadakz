<div class="modal fade bd-example-modal-lg" id="cardModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body cart modal__cart">
                <ul class="cart__items">
                    <li class="cart-product cart__item">
                        <div class="cart-product__wrap">
                            <div class="cart-product__image">
                                <img src="img/categories/17.png" alt="Product image">
                            </div>
                            <div class="cart-product__content">
                                <div class="cart-product__header">
                                    <div>
                                        <h4 class="cart-product__name">Диван-кровать Сириус Blue темно-голубого цвета</h4>
                                        <ul class="cart-product__info">
                                            <li class="cart-product__info-item">
                                                <span>Продавец:</span>
                                                <span><a href="#">Армада</a></span>
                                            </li>
                                            <li class="cart-product__info-item">
                                                <span>Модель:</span>
                                ...
                                <div class="cart-product__footer">
										<span class="quantity cart-product__quantity">
											...
											<span class="quantity__input-wrap">
												<span onclick="this.parentNode.querySelector('input[type=number]').stepUp()" class="quantity__operation quantity__operation--plus">+</span>
												<input type="number" class="quantity__input" value="1">
												<span onclick="this.parentNode.querySelector('input[type=number]').stepDown()" class="quantity__operation quantity__operation--minus">-</span>
											</span>
										</span>
                                    <div class="cart-product__total">
											<span class="price cart-product__price">
												<strike class="price__previous">98 000 <span class="currency">тг.</span></strike>
												<span class="price__special">90 400 <span class="currency">тг.</span></span>
											</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <li class="cart-product cart__item">
                        <div class="cart-product__wrap">
                            <div class="cart-product__image">
                                <img src="img/categories/13.png" alt="Product image">
                            </div>
                            <div class="cart-product__content">
                                <div class="cart-product__header">
                                    <div class="cart-product__details">
                                        <h4 class="cart-product__name">Диван с двумя креслами "Жаклин", новинка белорусской фабрики, Kazbelmebel - Салон Белорусской мебели</h4>
                                        <ul class="cart-product__info">
                                            <li class="cart-product__info-item">
                                                <span>Продавец:</span>
                                                <span><a href="#">Kazbelmebel - Салон Белорусской мебели</a></span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="cart-product__delete">
                                ...
                                <div class="cart-product__footer">
                                    ...
                                    <div class="cart-product__total">
											<span class="price cart-product__price">
												<span class="price__current">90 400 <span class="currency">тг.</span></span>
											</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="cart__total">
                    <a href="#" class="button btn-outline-grey rounded cart__continue">Продолжить покупки</a>
                                            ...
                                            <div class="together-item__product col-12 col-lg-6">
                                                <div class="product-card product-card--vertical">
                                                    <article class="product-card__wrap">
                                                        <a href="#" class="product-card__link">
                                                            <div class="product-card__image">
                                                                <img src="img/categories/18.png" alt="Product image" />
                                                            </div>
                                                            <div class="product-card__content product-card__content--wp">
                                                                <h4 class="product-card__title">Стол для детей</h4>
                                                                <span class="product-card__vendor">E-LIRA Белорусская мебель</span>
