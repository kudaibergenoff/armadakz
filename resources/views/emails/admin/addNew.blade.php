...
@section('title',"У нас новая публикация" )
                                ...
                                <tr>
                                    <td style="padding: 1rem 2rem;">
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td>
                                                    <h3>Магазин "{{ $new->store->title }}" добавил публикацию "{{ $new->title }}"</h3>
                                                    Подробности по <a href="{{ route('admin.publications.index') }}">ссылке</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
