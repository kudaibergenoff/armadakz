                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="padding: 1rem 2rem;">
                                        <h2 style="margin: 0">Дмитрий, ваш заказ принят!</h2>
                                        <p>Отслеживайте статус своего заказа в <a href="#">Личном кабинете</a></p>
                                        <h2 style="margin: 0">Заказ №1533497</h2>
                                        <span style="color: #8a8a8a">12.08.2020</span>
