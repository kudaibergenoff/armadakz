...
@section('title',"Регистрация прошла успешно" )
                                ...
                                <tr>
                                    <td style="padding: 1rem 2rem;">
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td>
                                                    <h3>Здравствуйте, Дмитрий! Регистрация прошла успешно!</h3>
                                                    <p>Ваш аккаунт создан и Вы можете войти, используя свой E-mail и пароль.</p>
                                                    <p><a href="#">Страница входа</a></p>
                                                    <p>После регистрации на сайте Вы сможете воспользоваться дополнительными возможностями: просмотр истории заказов, изменение информации Вашей учетной записи (адресов доставки, телефона для связи) и др.</p>
                                                    <p style="margin-top: 2rem">Спасибо, с уважением ARMADA.</p>
                                                </td>
                                            </tr>
                                        </table>
