...
@section('title',"Оставьте отзыв о покупке" )
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="padding: 1rem 2rem;">
                                        ...
                                        <p>Спасибо за то, что покупаете в нашем магазине. Нам и другим покуптелям очень важно занть ваше мнение о приобритенных товарах</p>
                                        <h2 style="margin: 0">Оцените свои покупки:</h2>

                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top: 1.75rem">
                                            <tr>
                                                ...
                                                <td width="65%" valign="top" style="padding: 1rem 0 1rem 2rem" class="sm-width-100 sm-px-0">
                                                    <h4 style="margin-top: 0; margin-bottom: 0">Диван-кровать Сириус Blue темно-голубого цвета</h4>
                                                    <p><span style="color: #8a8a8a">12.08.2020</span></p>
