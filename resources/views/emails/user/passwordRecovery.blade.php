                                ...
                                <tr>
                                    <td style="padding: 1rem 2rem;">
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td>
                                                    <h3>Восстановление пароля на ARMADA</h3>
                                                    <p>Вы запросили инструкцию, на восстновление пароля</p>
                                                    <p>Для вашего аккаунта <span style="color: #d60019;">nooutway@gmail.com</span> был установлен новый временный пароль <b style="color: #d60019; font-size: 1.2rem">J7saeR=123&</b></p>
                                                    <p style="color: #a6a6a6; font-size: .9rem">*Если вы считаете, что данное сообщение отправлено вам ошибочно, просто проигнорируйте его</p>
