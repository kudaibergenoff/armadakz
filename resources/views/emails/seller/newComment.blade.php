                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="padding: 1rem 2rem;">
                                        <h2 style="margin: 0">Здравствуйте Дмитрий! У вас новый комментарий</h2>
                                        <p>Управляйте комментариями в <a href="{{ route('seller.reviews.index') }}">Личном кабинете продавца</a></p>
                                    </td>
                                </tr>
                            </table>
                            <!-- CONTENT END -->
