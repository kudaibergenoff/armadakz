@if(isset($collections) and $collections->count() > 0)
    <section class="section slideshow section--slideshow page-product__collection mt-85 mb-85">
        <div class="container">
            <div class="section__header">
                <h2 class="section__title section__title--dark">Из этой же коллекции</h2>
            ...
            <div class="section__content">
                <ul class="slideshow__items recommended__items">
                    @foreach($collections as $collection)
                        @include('pages.home.__card',['item'=>$collection,'wp'=>true])
                    @endforeach
                </ul>
