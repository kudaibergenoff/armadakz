@if(isset($others) and $others->count() > 0)
    <section class="section slideshow section--slideshow page-product__other mt-85 mb-85">
        <div class="container">
            <div class="section__header">
                <h2 class="section__title section__title--dark">Другие товары этого производителя</h2>
            ...
            <div class="section__content">
                <ul class="slideshow__items recommended__items">
                    @foreach($others as $other)
                        @include('pages.home.__card',['item'=>$other,'wp'=>true])
                    @endforeach
                </ul>
