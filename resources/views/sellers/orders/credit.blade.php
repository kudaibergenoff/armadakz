        ...
        <div class="d-flex">
            ...
            <div class="vendor__content flex-grow-1 vendor__content--products">
                ...
                <div class="shops orders vendor__shops pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    <form action="{{ route('sellers.orders.update',$data->id) }}" class="was-validated change-shop pb-4 border-bottom" method="POST" enctype="multipart/form-data">
                        @method('PATCH')
                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <p>
                                                ...
                                                @include('layouts.forms.input',['type'=>'email','name'=>'email'])
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
