...
{{--    </td>--}}
    ...
    <td>
        <span class="font-weight-bold">{{ $new->title }}</span><br>
        {{ $new->description }}
        <hr class="my-1">
    ...
    <td class="text-center">
        <a href="{{ route('seller.news.edit',['id'=>$new->id]) }}" class="products-table__edit" >
...
{{--            <input type="hidden" name="edit-product-isActive" value="{{ $new->isActive  }}">--}}
        ...
        <a href="{{ route('seller.news.destroy',['id'=>$new->id]) }}" class="products-table__delete ml-2">
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
