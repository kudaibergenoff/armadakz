...
@section('title','ARMADA - Публикации' )
                ...
                <div class="products orders vendor__products pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    <div class="orders__header justify-content-between">
                        <div class="d-flex align-content-center flex-wrap">
                            <h2 class="page-title orders__title mr-4 mb-2">Публикации</h2>
                            <div>
                                <button class="button btn-sm btn-success products__add mr-2 mb-2">
                                    <a href="{{ route('seller.news.create') }}">Добавить</a>
                                </button>
...
{{--                                    <th>Теги</th>--}}
                            ...
                            <tbody>
                                @each('sellers.news._table_news',$news,'new')
                            </tbody>
                        </table>
                    </div>
                </div>
