            ...
            <div class="vendor__content vendor__content--settings flex-grow-1 bg-light vendor__content--panel">
                ...
                <div class="panel orders vendor__panel mt-lg-2 pt-4 pb-3 p-lg-3 pr-0">
                    <div class="user-block">
                        <form action="{{ route('seller.infoEdit') }}" class="user-block__wrap" id="seller-edit" method="POST">
                            @csrf
                            ...
                            <div>
                                @include('sellers.personal_data._personal')
                                @include('sellers.personal_data._contact')
                                @include('sellers.personal_data._auth')
                                {{--@include('sellers.personal_data._avatar')--}}
                                {{--@include('sellers._____personal_data._additional')--}}
                            </div>
                        </form>
                        <div class="text-right">
{{--                            <button type="submit" form="seller-edit" class="button btn-outline-dark d-block d-sm-inline mt-3 mx-auto mx-sm-0">Сохранить</button>--}}
