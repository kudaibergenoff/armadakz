            ...
            <ul class="user-block__items row">
                <li class="user-block-info user-block__item col-12 col-md-6 col-xl-4">
                    ...
                    <div class="user-block-info__value">
                        <input type="text" class="form-control user-block-info__value--no-change" name="login" value="">
...
{{--                        <input type="password" class="form-control user-block-info__value--password" name="new-password" value="" placeholder="Новый пароль">--}}
{{--                        <input type="password" class="form-control user-block-info__value--password" name="current-password" value="" placeholder="Старый пароль">--}}
{{--                        <span>********</span>--}}
{{--                    </div>--}}
                </li>
            </ul>
