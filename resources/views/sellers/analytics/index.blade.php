...
{{--                            <input type="text" name="daterange" class="picker__input" value="Выберите период..." />--}}
                            @include('layouts.forms.input',[
                                    ...
                                    'required'=>true,
                                    'data_attributes' => [ 'data-route' => route('seller.analytics') ]
                                ])
                        </div>
                    </div>
                    @include('sellers.analytics._tabs')
                    <div class="chart analytics__chart analytics__block-style">
                        @include('sellers.analytics._graph')
                        @include('sellers.analytics._statistics')
                    </div>
                    <div class="row">
                        @include('sellers.analytics._new_clients')
                        @include('sellers.analytics._assortment_analysis')
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    @include('sellers.analytics._datepicker')
