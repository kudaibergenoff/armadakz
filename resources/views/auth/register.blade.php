...
@section('content')
    ...
    <div class="page-login__bg" style="background: url('{{ asset('img/sections-bg/register-bg.jpg') }}')">
        ...
        <form {{ route('register') }} class="d-flex flex-column justify-content-between h-100 needs-validation" novalidate method="POST">
            @csrf
            ...
            <div>
                <h3 class="h4 pb-3 border-bottom text-center login__title">Регистрация</h3>
                ...
                <div class="row">
                    <div class="col-12 col-xl">
                        <div class="md-form mt-0 mb-xl-0 md-outline input-with-pre-icon">
                            ...
                            <input type="text" name="name" id="register-name" class="form-control mb-0" value="{{ old('name') }}" required>
                    ...
                    <div class="col-12 col-xl">
                        <div class="md-form m-0 md-outline input-with-pre-icon">
                            ...
                            <input type="text" name="sname" id="register-surname" class="form-control mb-0" value="{{ old('sname') }}">
                ...
                <div class="md-form mb-0 md-outline input-with-pre-icon">
                    ...
                    <input type="tel" name="phone" id="register-phone" class="form-control mb-0" value="{{ old('phone') }}" autocomplete="phone" placeholder="+7 (---) --- -- --" required>
                ...
                <p class="text-center">
                    <a href="{{ route('login') }}" class="d-flex align-items-center justify-content-center font-weight-semibold login__as-seller">
                        <span class="mr-2">У меня уже есть аккаунт</span>
...
{{--                    <p class="text-center">--}}
{{--                        <a href="{{ route('sellerRegister') }}" class="d-flex align-items-center justify-content-center font-weight-semibold login__as-seller">--}}
{{--                            <span class="mr-2">Зарегистрироваться как продавец</span>--}}
{{--                            <svg width="8" height="11" viewBox="0 0 8 11" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
{{--                                <path d="M7.12779 5.10739L1.73144 0.162381C1.49466 -0.0541269 1.11102 -0.0541269 0.873636 0.162381C0.636848 0.378888 0.636848 0.730553 0.873636 0.947061L5.84195 5.4997L0.874234 10.0523C0.637446 10.2689 0.637446 10.6205 0.874234 10.8376C1.11102 11.0541 1.49525 11.0541 1.73204 10.8376L7.12839 5.89257C7.36159 5.6783 7.36159 5.32111 7.12779 5.10739Z" fill="#393939"/>--}}
{{--                            </svg>--}}
{{--                        </a>--}}
{{--                    </p>--}}
            ...
            <div class="text-center mt-2">
                <div class="d-flex align-items-center justify-content-between" style="color: #787878;">
                    ...
                    <span class="col" style="white-space: nowrap">Войти как пользователь</span>
                    <span class="flex-grow-1"><hr></span>
                </div>
